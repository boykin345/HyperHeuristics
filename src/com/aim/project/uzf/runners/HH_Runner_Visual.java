 ...
 *
 *        Runs a hyper-heuristic using a default configuration then displays the
 *        best solution found.
 */
public abstract class HH_Runner_Visual {
	...
	/**
	 * Transforms the best solution found, represented as a TSPSolution, into an
	 * ordering of Location's
